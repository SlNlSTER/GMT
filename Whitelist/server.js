...
var guildId = "983909819129933944"; // Guild ID for a Discord Server, see https://faxes.zone/i/zjKnd.png
var botToken = "OTg5OTI4ODI4MDM2MDc1NTkx.Gqk0tF.oP8oeYjlLbMBWJbNha9szC0JIKgFzMMhfYWc20"; // This must be a Discord bot token, create a bot @ https://discord.com/developers/applications
...
var notWhitelistedMessage = "You're Not Whitelisted. Join GBRP discord and verify.";
var noGuildMessage = "You're Not Whitelisted. Join GBRP discord and verify.";
        ...
        setTimeout(async function() {
            getUserDiscord(src, async function(userId) {
                if(userId) {
                    ...
                    return deferrals.done(`Your Discord credentials were not detected`);
                }
            });
        }, 0)
    }, 0)
