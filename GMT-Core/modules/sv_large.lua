...
RegisterServerEvent("GBRP:BuyGun")
AddEventHandler('GBRP:BuyGun', function(hash)
    local source = source
...
RegisterServerEvent("GBRP:BuyArmour")
AddEventHandler('GBRP:BuyArmour', function(price, amount)
    local source = source
